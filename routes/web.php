...
Route::get('/student/{id}', [StudentController::class, 'show'])->middleware(['auth', 'must-admin-ir-teacher']);
Route::get('/student-add', [StudentController::class, 'create'])->middleware(['auth', 'must-admin-ir-teacher']);
Route::post('student', [StudentController::class, 'store'])->middleware(['auth', 'must-admin-ir-teacher']);
Route::get('/student-edit/{id}', [StudentController::class, 'edit'])->middleware(['auth', 'must-admin-ir-teacher']);
Route::put('/student/{id}', [StudentController::class, 'update'])->middleware(['auth', 'must-admin-ir-teacher']);
